...
<body>
        ...
        <aside class="container alert alert-info" id="entete">
            ...
            <nav class="bg-light rounded shadow-sm p-3 text-left">
                <div class="nav-content">
                    ...
                    <a href="{{ route('profile_eleve') }}" class="btn btn-custom">
                        <i class="fas fa-home me-2"></i>ACCUEIL
                    </a>
                    <a href="{{ route('mes_payements') }}" class="btn btn-custom">
    ...
    <footer>
        <p>&copy; {{ date('Y') }} Tous droits réservés à <strong>LYCÉE TWENDELEYE</strong></p>
        <p class="mt-2">
